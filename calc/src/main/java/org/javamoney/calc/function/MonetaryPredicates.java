 ...
 * functionalities to of and combine predicates as, well as predicate based
...
public final class MonetaryPredicates{
     ...
     *
     * @param predicate The predicate to be inversed, not {@code null}.
     ...
     *
     * @param values The values to be accepted, not {@code null}.
     ...
     * predicate.
     *
     * @param min       the minimum of items required.
     * @param predicate The predicate to be used for selecting, not {@code null}.
     ...
     * the predicate.
     *
     * @param max       the maximum of items required.
     * @param predicate The predicate to be used for selecting, not {@code null}.
     * @return the evaluating predicate based on the values passed, never
     * {@code null}.
     */
     ...
     *
     * @param predicate The selecting predicate.
