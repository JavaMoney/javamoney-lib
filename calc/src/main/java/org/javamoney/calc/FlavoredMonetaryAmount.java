...
public final class FlavoredMonetaryAmount implements MonetaryAmount{
     ...
     *
     * @param flavor the new flavor, or {@code null}.
     */
     ...
     * @param newFlavor the {@link String} for the result instance.
     * @return the result, with the given flavor.
     */
    public FlavoredMonetaryAmount of(MonetaryAmount amount, String newFlavor){
     ...
     */
    public FlavoredMonetaryAmount with(MonetaryOperator operator, String newFlavor){
        return of(this.baseAmount.with(operator), newFlavor);
    }
    ...
    public FlavoredMonetaryAmount add(MonetaryAmount amount){
        return new FlavoredMonetaryAmount(this.baseAmount.add(amount), null);
    }

    @Override
    public FlavoredMonetaryAmount subtract(MonetaryAmount amount){
        return new FlavoredMonetaryAmount(this.baseAmount.subtract(amount), null);
    }

    @Override
    public FlavoredMonetaryAmount multiply(long multiplicand){
        return new FlavoredMonetaryAmount(this.baseAmount.multiply(multiplicand), null);
    }
    ...
    public FlavoredMonetaryAmount divide(long divisor){
        return new FlavoredMonetaryAmount(this.baseAmount.divide(divisor), null);
    }
    ...
    public FlavoredMonetaryAmount remainder(long divisor){
        return new FlavoredMonetaryAmount(this.baseAmount.remainder(divisor), null);
    }
    ...
    public FlavoredMonetaryAmount[] divideAndRemainder(long divisor){
        ...
        return new FlavoredMonetaryAmount[]{new FlavoredMonetaryAmount(result[0], null),
    ...
    public FlavoredMonetaryAmount divideToIntegralValue(long divisor){
        return new FlavoredMonetaryAmount(this.baseAmount.divideToIntegralValue(divisor), null);
    }
    ...
    public FlavoredMonetaryAmount scaleByPowerOfTen(int power){
        return new FlavoredMonetaryAmount(this.baseAmount.scaleByPowerOfTen(power), null);
    }
    ...
    public FlavoredMonetaryAmount stripTrailingZeros(){
        return new FlavoredMonetaryAmount(this.baseAmount.stripTrailingZeros(), amountType);
    }
